...
map.getView().fit([-3953823.517619, 5009463.142544, 1280285.329035, 8302835.001112], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Irish Potato Famine</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (243 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The Irish Potato Famine ravaged Ireland in between the years 1845 and 1851.<br />It was caused by the devasta􀆟ng potato blight caused by a fungal disease, a disease that<br />destroys both the leaves and the edible roots, or tubers, of the potato plant.';
            }
